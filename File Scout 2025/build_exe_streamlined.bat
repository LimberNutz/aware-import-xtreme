@echo off
REM ========================================
REM File Scout 3.3 - Streamlined Build Script
REM ========================================
REM This script builds File Scout as a standalone .exe
REM while excluding unnecessary ML/TensorFlow packages.

echo.
echo ========================================
echo File Scout 3.3 - Streamlined EXE Builder
echo ========================================
echo.
...
echo.
echo [5/6] Building executable (streamlined)...
echo This version excludes ML packages for faster build...
echo.

REM Build the executable with exclusions for unnecessary packages
pyinstaller ^
  --name "FileScout" ^
  --windowed ^
  --onefile ^
