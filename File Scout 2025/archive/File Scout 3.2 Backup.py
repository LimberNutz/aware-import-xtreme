...
from PyQt6.QtCore import Qt, QThread, pyqtSignal, QSize, QDate, QSettings, QObject, QTimer, QEvent
from PyQt6.QtGui import QIcon, QColor, QAction, QActionGroup, QBrush, QPixmap, QGuiApplication
    ...
    def update_preview(self):
        ...
        if mime_type and mime_type.startswith('image/'):
            ...
            if not pixmap.isNull():
                ...
                self.preview_tabs.setTabVisible(0, True)
                self.preview_tabs.setTabVisible(1, False)
                self.preview_tabs.setCurrentIndex(0)
            else:
                self.text_preview.setPlainText("Cannot load image.")
                self.preview_tabs.setTabVisible(0, False)
